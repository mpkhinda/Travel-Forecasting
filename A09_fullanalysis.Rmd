...
```{r geography, roads, transit, centroids, echo=FALSE, fig.cap='The Components of our Model:Roads, Centroids, Centroid Connectors, and Transit Lines', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r flows geom processing, fig.cap='Oklahoma County has the Most Employees in the MSA, and the Majority Are Service Sector Workers', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r map-cong-time-all, fig.cap='TKTK', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r map-cong-time-filter, fig.cap='TKTK', out.width='80%', fig.asp=.75, fig.align='center'}
ggplot(subset(TA_flows_geom, congestion_time < 240)) + 
  geom_sf(aes(color = congestion_time)) +
  scale_color_continuous(type = "gradient") + 
  theme_void()
```
```{r map-cong-time-non-connector, fig.cap='TKTK', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r map-non-connector-VMT-filter, fig.cap='TKTK', out.width='80%', fig.asp=.75, fig.align='center'}
ggplot(subset(TA_flows_geom, Type != "")) + 
...
```{r map-non-connector-VMT, fig.cap='TKTK', out.width='80%', fig.asp=.75, fig.align='center'}
ggplot(TA_flows_geom) + 
  geom_sf(aes(color = Tot_VMT)) +
