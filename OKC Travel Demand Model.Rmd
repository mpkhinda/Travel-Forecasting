...
```{r pop_density_map, fig.height = 3.5, fig.align = "left", fig.cap="\\label{fig:figs}Map showing the population density in the Oklahoma City MSA", echo=FALSE}
...
pop_density_map <- ggplot(ok_msa) +
  ...
  scale_fill_gradientn(colors = blue_pal, name = "People / square meter", labels = paste(seq(0,4)*.0001)) +
  theme_void()
