...
```{r geog, fig.width=15, echo=FALSE}
...
```{r employemnt chart, fig.width=12, echo=FALSE}
...
```{r income_distribution, fig.width=12, echo=FALSE}
...
```{r poverty_map, fig.width=15, echo=FALSE}
...
```{r vehicle_ownership, fig.width=15, echo=FALSE}
