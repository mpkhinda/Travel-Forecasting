...
```{r income-distribution, echo=FALSE, warning=FALSE, fig.cap='Figure 1. The Median Household Income in the Oklahoma City MSA was $59,084 in 2019', out.width='80%', fig.asp=.75, fig.align='center'}
...
[details on how we structure the UBI program in our scenario]

Goal: 
* Improving quality of life and understanding the impact of UBI on travel.

Outcome: 
* Increase the number of overall trips, and specifically non-work-related trips.

Strategy: 
* $12,000 unconditional cash transfer to all residents of the MSA; modeled as a naive form of UBI which has been proposed by some politicians (Andrew Yang)

Test (How to Measure): 
*Change median income
* Rerun linear regression in trip generation stage
* Generate new number of productions and attractions, and compare to number of trips (and share of trips by purpose) in original model
* Rerun trip distribution, mode choice, trip assignment  

Assumptions
* Residents will not relocate given an increase in income
* Residents will keep the same jobs and level of employment, meaning the income is entirely supplemental 
* Any resulting change in vehicle ownership would not be captured by our current model of productions/attractions 
* Households will not have more children based on their change in income 
* Households will not be more likely to move from renting to owning a home as a result of this this income
* Households will not be more or less likely to have someone 65 or older living in them because of this income
